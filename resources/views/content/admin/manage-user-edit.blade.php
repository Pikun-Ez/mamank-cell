                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="wrap-input100 validate-input input-group">
                                        ...
                                        <input class="input100 form-control" name="username" value="{{ $user->username }}" type="text" placeholder="Username">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="wrap-input100 validate-input input-group">
                                        ...
                                        <input class="input100 form-control" name="email" value="{{ $user->email }}" type="text" placeholder="Email">
                                    </div>
                                </div>
                                <div class="form-group">
